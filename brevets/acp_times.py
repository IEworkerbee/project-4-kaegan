...
class BrevetDistERROR(Exception):
    ...
    def __str__(self):
       print("brevet_dist_km must be either 200, 300, 400, 600, or 1000. You entered {0}".format(self.brevet_dist_km))
...
class ControlDistERROR(Exception):
   ...
   def __str__(self):
      print("control_dist_km must be a value >= 0 and <= 1000. It also must be less then the brevet_dist_km. You entered {0}".format(self.control_dist_km))
